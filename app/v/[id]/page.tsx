...
export default async function Video({ params }: PageProps) {
    ...
    if (data.status !== 200) {
        ...
        url: `https://paksaanak.pages.dev/v/${file.file_code}#${file.file_title}`,
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://paksaanak.pages.dev/v/${file.file_code}#${file.file_title}`
            }  
        }
        }
...
<meta itemProp="uploadDate" content={`${new Date(
	...
	<section>
        ...
        {/* ... */}
                        ...
                        <iframe
                className="w-full h-[50vh] md:h-[55vh] lg:h-[70vh]"
